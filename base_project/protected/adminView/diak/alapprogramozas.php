...
<?php
    ...
    $query = "SELECT count(*) as total from alapprogramozasfeladatok;";
    $queryParams = [
...
<form method="POST">
  ...
  <tr>
    ...
    <th  colspan="2"  ><?php echo $_SESSION['question']?></th> 
     ...
     <th><a href="http://localhost/base_project/admin/index.php"><h3>Programozás kérdés sor befejezése</h3></a></th>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    ...
    <td><input type="radio" name="answer" value=3 checked=""><?php echo $_SESSION['answer3']?></td>
...
<?php 
 ...
 if(array_key_exists('next', $_POST)){
     ...
     if(!empty($_POST['answer'])) {
         ...
         $query = "INSERT INTO programozasteszt
